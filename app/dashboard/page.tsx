...
import { Lock, Sparkles, ShieldCheck, ArrowUpRight, Grid3X3, EyeOff } from "lucide-react";
...
function StatCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-[28px] border border-yellow-400/12 bg-[linear-gradient(180deg,rgba(255,255,255,0.045),rgba(255,255,255,0.02))] p-5 shadow-[0_12px_30px_rgba(0,0,0,0.35)] backdrop-blur-md transition duration-300 hover:-translate-y-0.5 hover:border-yellow-300/20">
      <div
      ...
      <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
        {categories.map((category) => {
          ...
          return (
            <div
              key={category.href}
              className="group relative overflow-hidden rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(15,15,15,0.95),rgba(10,10,10,0.90))] p-5 shadow-[0_8px_22px_rgba(0,0,0,0.22)] transition duration-300 hover:border-white/15"
            >
              ...
              <div className="relative flex items-start justify-between gap-3">
                <div>
                  ...
                  <h2 className="mt-4 text-xl font-black text-white/88">
                    {category.title}
                  </h2>
